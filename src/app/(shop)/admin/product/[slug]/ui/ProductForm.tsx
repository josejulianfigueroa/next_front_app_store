...
import { Product, ProductImage as ProductWithImage, ProductWithImagesData } from "@/interfaces";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {product.images?.map((image) => (
              <div key={image.id}>
                ...
                <button
                  type="button"
                  onClick={() => deleteProductImage(image.id, image.url, product.slug)}
                  >
                  Eliminar
                </button>
              </div>
